...
router.get("/user-profile/setup-session", OnboardingController.getUserProfileSetupSession);
router.post("/user-profile/complete", OnboardingController.completeUserProfileSetup);
